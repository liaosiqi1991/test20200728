   ...
   Begin MSComctlLib.ImageList imgTbrS 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage8 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmPatholSpecialExamined.frx":572A
            Key             =   ""
         EndProperty
      EndProperty
   End
...
On Error GoTo ErrorHand
    ...
    Select Case Control.ID
        ...
        Case conMenu_PatholSpeExam_Cancel
            '特检回退
            Call SpeExamined_Cancel
...
On Error GoTo ErrorHand
    ...
    Select Case Control.ID
        ...
        Case conMenu_PatholSpeExam_Accept, conMenu_PatholSpeExam_Finish, conMenu_PatholSpeExam_Cancel
...
'创建影像记录对应的菜单
    ...
    If Not HasMenu(objMenuBar, conMenu_PatholSpeExam) Then
        ...
        With cbrMenuBar.CommandBar
            ...
            Set cbrControl = CreateModuleMenu(.Controls, xtpControlButton, conMenu_PatholSpeExam_Cancel, "特检回退(&H)", "", 1, True)
...
Private Sub SpeExamined_Cancel()
'特检撤回
On Error GoTo errH
    Dim Row As Integer
    Dim ID As String
    ...
    ID = ufgData.Text(Row, gstrSpeExam_特检ID)
    If Trim(ID) = "" Then
        Call MsgBoxD(Me, "请选择需要回退的项目。")
        Exit Sub
    End If
    
    strSQL = "Zl_病理特检_退回(" & ID & ")"
    Call zlDatabase.ExecuteProcedure(strSQL, Me.Caption)
    
    Call ufgData.SyncText(Row, gstrSpeExam_当前状态, "已申请", True)
    Call ufgData.SyncData(Row, gstrSpeExam_完成时间, Null, True)
    Call ufgData.SyncText(Row, gstrSpeExam_特检医师, "", True)
    Exit Sub
errH:
    If ErrCenter() = 1 Then Resume
    Call SaveErrLog
...
On Error GoTo errH
    ...
    strSQL = "Zl_病理特检_确认('" & mrecStudyInf.lngPatholAdviceId & "'," & GetSelectSpeExamType & "," & zlStr.To_Date(dtServicesTime) & ")"
    Call zlDatabase.ExecuteProcedure(strSQL, Me.Caption)
...
On Error GoTo errH
    ...
    With cbrToolBar.Controls
        ...
        Set cbrControl = .Add(xtpControlButton, conMenu_PatholSpeExam_Cancel, "特检回退"): cbrControl.IconId = 5019: cbrControl.ToolTipText = "特检回退"
        cbrControl.BeginGroup = True
