...
Public Function ShowRejectWindow(ByVal lngAdviceId As Long, ByVal lngReportID As Long, _
    Owner As Object) As Boolean
'显示报告驳回窗口
...
On Error GoTo errhandle
    ...
    strSQL = "ZL_影像报告驳回(" & mlngAdviceID & "," & mlngReportID & ",'" & rtbReason.Text & "'," & zlStr.To_Date(dtpRejectDate.value) & ",'" & txtRejectUser.Text & "')"
