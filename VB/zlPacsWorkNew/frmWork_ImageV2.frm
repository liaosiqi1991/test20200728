...
On Error GoTo DBError
    ...
    Set rsTemp = zlDatabase.OpenSQLRecord(strSQL, Me.Caption, mobjStudyInfo.lngAdviceId)
...
On Error GoTo errhandle
    ...
    ElseIf mobjStudyInfo.intImageLocation = 0 Then    '图像在中联PACS
        If Not mObjNotify Is Nothing Then Call mObjNotify.Broadcast(BM_IMAGE_EVENT_DEL, 0, mobjStudyInfo.lngAdviceId, mobjStudyInfo.lngSendNo)
        ...
        If Not mObjNotify Is Nothing Then Call mObjNotify.Broadcast(BM_IMAGE_EVENT_DEL, 1, mobjStudyInfo.lngAdviceId, mobjStudyInfo.lngSendNo, -1)
    End If
Exit Sub
errhandle:
    If ErrCenter = 1 Then Resume
...
'显示观片站
    ...
    If lvwSeq.SelectedItem Is Nothing Then
        Call OpenLatestImage(Me, mobjPacsCore, mobjStudyInfo, mintViewHistoryImageDays, mblnLocalizerBackward)
    Else
        ...
        OpenViewer 1, mobjPacsCore, mobjStudyInfo.lngAdviceId, mblnAddImage, Me, strSerials, mobjStudyInfo.blnMoved, mblnLocalizerBackward, intImageInverval, strImages
    End If
    Exit Sub
CallError:
    If ErrCenter() = 1 Then Resume
...
'------------------------------------------------
    ...
    If blImgDeleted Then '有图像被删除
        If Not mObjNotify Is Nothing Then Call mObjNotify.Broadcast(BM_IMAGE_EVENT_DEL, 1, mobjStudyInfo.lngAdviceId, mobjStudyInfo.lngSendNo)
    End If
