...
Public Function ShowPacsInterfaceCfgV2(objParent As Object, ByVal lngModule As Long, ByVal strPrivs As String, _
                                ByVal lngAdviceId As Long, ByVal lngSendNo As Long, ByVal lngPatId As Long) As Boolean
...
On Error GoTo errH
    ...
    For i = 1 To vsfAppFuns.Rows - 1
        If mblnIsV2 Then
            intType = CInt(convertInterfaceTimeV2(vsfAppFuns.TextMatrix(i, mAppFuncCol.自动执行时机), True))
        Else
...
'    菜单执行 = 100
        If mblnIsV2 Then
            .ColComboList(5) = "不自动执行|检查登记|检查报到|检查完成|图像采集|报告保存|报告签名|报告审核|取消登记|取消报到|取消完成|删除图像|删除报告|报告回退|报告驳回|菜单执行|"
        Else
...
On Error GoTo errH
    ...
    For i = 1 To rsTemp.RecordCount
        ...
        If mblnIsV2 Then
            vsfAppFuns.TextMatrix(i, mAppFuncCol.自动执行时机) = convertInterfaceTimeV2(zlCommFun.nvl(rsTemp!自动执行时机), False)
        Else
...
Private Function convertInterfaceTimeV2(ByVal strtext As String, ByVal intConvetType As Boolean) As String
'将执行时机由汉字转换成数字，默认为0(不执行)
'intConvetType说明 : true ：str转int  false：int转str
    If intConvetType Then
        convertInterfaceTimeV2 = 0
        
        Select Case strtext
            Case "不自动执行"
                convertInterfaceTimeV2 = EInterfaceExeTimeV2.不自动执行
            Case "检查登记"
                convertInterfaceTimeV2 = EInterfaceExeTimeV2.检查登记
            Case "检查报到"
                convertInterfaceTimeV2 = EInterfaceExeTimeV2.检查报到
            Case "图像采集"
                convertInterfaceTimeV2 = EInterfaceExeTimeV2.图像采集
            Case "报告保存"
                convertInterfaceTimeV2 = EInterfaceExeTimeV2.报告保存
            Case "报告签名"
                convertInterfaceTimeV2 = EInterfaceExeTimeV2.报告签名
            Case "报告审核"
                convertInterfaceTimeV2 = EInterfaceExeTimeV2.报告审核
            Case "检查完成"
                convertInterfaceTimeV2 = EInterfaceExeTimeV2.检查完成
            Case "取消登记"
                convertInterfaceTimeV2 = EInterfaceExeTimeV2.取消登记
            Case "取消报到"
                convertInterfaceTimeV2 = EInterfaceExeTimeV2.取消报到
            Case "删除图像"
                convertInterfaceTimeV2 = EInterfaceExeTimeV2.删除图像
            Case "删除报告"
                convertInterfaceTimeV2 = EInterfaceExeTimeV2.删除报告
            Case "报告回退"
                convertInterfaceTimeV2 = EInterfaceExeTimeV2.报告回退
            Case "取消完成"
                convertInterfaceTimeV2 = EInterfaceExeTimeV2.取消完成
            Case "报告驳回"
                convertInterfaceTimeV2 = EInterfaceExeTimeV2.报告驳回
            Case "菜单执行"
                convertInterfaceTimeV2 = EInterfaceExeTimeV2.菜单执行
        End Select
        
    Else
        convertInterfaceTimeV2 = "不自动执行"
        
        Select Case strtext
            Case EInterfaceExeTimeV2.不自动执行
                convertInterfaceTimeV2 = "不自动执行"
            Case EInterfaceExeTimeV2.检查登记
                convertInterfaceTimeV2 = "检查登记"
            Case EInterfaceExeTimeV2.检查报到
                convertInterfaceTimeV2 = "检查报到"
            Case EInterfaceExeTimeV2.图像采集
                convertInterfaceTimeV2 = "图像采集"
            Case EInterfaceExeTimeV2.报告保存
                convertInterfaceTimeV2 = "报告保存"
            Case EInterfaceExeTimeV2.报告签名
                convertInterfaceTimeV2 = "报告签名"
            Case EInterfaceExeTimeV2.报告审核
                convertInterfaceTimeV2 = "报告审核"
            Case EInterfaceExeTimeV2.检查完成
                convertInterfaceTimeV2 = "检查完成"
            Case EInterfaceExeTimeV2.取消登记
                convertInterfaceTimeV2 = "取消登记"
            Case EInterfaceExeTimeV2.取消报到
                convertInterfaceTimeV2 = "取消报到"
            Case EInterfaceExeTimeV2.删除图像
                convertInterfaceTimeV2 = "删除图像"
            Case EInterfaceExeTimeV2.删除报告
                convertInterfaceTimeV2 = "删除报告"
            Case EInterfaceExeTimeV2.报告回退
                convertInterfaceTimeV2 = "报告回退"
            Case EInterfaceExeTimeV2.取消完成
                convertInterfaceTimeV2 = "取消完成"
            Case EInterfaceExeTimeV2.报告驳回
                convertInterfaceTimeV2 = "报告驳回"
            Case EInterfaceExeTimeV2.菜单执行
                convertInterfaceTimeV2 = "菜单执行"
