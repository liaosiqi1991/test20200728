...
Begin VB.Form frmXWRelateImage 
   ...
   Begin VB.CommandButton AllPick 
      Caption         =   "序列全选"
      Height          =   350
      Left            =   120
      TabIndex        =   24
...
On Error GoTo errHandle
    ...
    For i = 1 To lvwSeries.ListItems.Count
        lvwSeries.ListItems(i).Checked = False
    Next
    Exit Sub
errHandle:
End Sub

Private Sub AllPick_Click()
On Error GoTo errHandle
    Dim i As Integer

    For i = 1 To lvwSeries.ListItems.Count
        lvwSeries.ListItems(i).Checked = True
    Next
    Exit Sub
errHandle:
End Sub
