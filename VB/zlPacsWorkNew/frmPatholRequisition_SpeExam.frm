...
On Error GoTo errH
    ...
    If mlngCurRequestId <= 0 Then
        ...
        mufgParentRequest.Text(lngNewRow, gstrRequisition_申请类型) = Trim(zlStr.SubB(cbxSpeExamType.Text, InStr(1, cbxSpeExamType.Text, "-") + 1, 10))
...
'取得当前选择的材块ID
    GetSelectedMaterialId = zlStr.SubB(cbxMaterial.Text, 1, InStr(1, cbxMaterial.Text, "(") - 1)
End Function
...
On Error Resume Next
    ...
    Set mufgParentRequest = Nothing
    Set mufgParentContext = Nothing
