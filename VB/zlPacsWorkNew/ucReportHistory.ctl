   ...
   Begin VB.PictureBox picBack 
      ...
      Begin VB.PictureBox picContext 
         ...
         Begin VB.CheckBox chkReportType 
            BackColor       =   &H00FFFFFF&
            DownPicture     =   "ucReportHistory.ctx":16C2
            Height          =   375
            Left            =   0
            Picture         =   "ucReportHistory.ctx":2D84
            Style           =   1  'Graphical
            TabIndex        =   5
            Top             =   0
            Width           =   1335
         ...
         Begin RichTextLib.RichTextBox rtxtReport 
            ...
            Appearance      =   0
            AutoVerbMenu    =   -1  'True
            TextRTF         =   $"ucReportHistory.ctx":4446
         End
      End
...
Public Function Refresh(ByVal lngAdviceId As Long, Optional blnForce As Boolean = False) As Boolean
'刷新历史检查列表
    Dim dtBegin As Date
    Dim dtEnd As Date
...
'    End If
    ...
    cmdWrite.Enabled = vsfStudy.Rows > 1
