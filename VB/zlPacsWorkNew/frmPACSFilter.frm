...
Private Const C_LNGSETCBOWIGHT As Long = &H160
Private Const C_INTWITH300 As Integer = 300
...
Private Sub cboAuditing_DropDown()
On Error Resume Next
    Call SendMessage(cboAuditing.hWnd, C_LNGSETCBOWIGHT, C_INTWITH300, 0)
    err.Clear
End Sub

Private Sub cboDept_DropDown()
On Error Resume Next
    Call SendMessage(cboDept.hWnd, C_LNGSETCBOWIGHT, C_INTWITH300, 0)
    err.Clear
End Sub

Private Sub cboDiagDOC_DropDown()
On Error Resume Next
    Call SendMessage(cboDiagDOC.hWnd, C_LNGSETCBOWIGHT, C_INTWITH300, 0)
    err.Clear
End Sub
...
On Error Resume Next
    Call SendMessage(cboPart.hWnd, C_LNGSETCBOWIGHT, C_INTWITH300, 0)
    err.Clear
End Sub
...
Private Sub cboPartGroup_DropDown()
On Error Resume Next
    Call SendMessage(cboPartGroup.hWnd, C_LNGSETCBOWIGHT, C_INTWITH300, 0)
    err.Clear
End Sub

Private Sub cbo检查技师_DropDown()
On Error Resume Next
    Call SendMessage(cbo检查技师.hWnd, C_LNGSETCBOWIGHT, C_INTWITH300, 0)
    err.Clear
End Sub
...
Private Sub GetQuerySchemaCfg(ByRef strSchemaFormat As String, ByRef strSchemaField As String)
    ...
    If cboSex.ListIndex <> 0 Then strSchema = strSchema & GetFieldFormatStr("性别", "病人信息", "<=", zlStr.NeedName(cboSex.Text), "And", "")
...
Private Sub Form_Unload(Cancel As Integer)
    ...
    Set mrsStudyPart = Nothing
    Set mrsPartGroup = Nothing
End Sub
