...
Public Const conMenu_Manage_AttachMoney = 239      '弹窗口补费
Public Const conMenu_Manage_CompleteAttach = 240   '完成补费
...
Public Const conMenu_Manage_ModifBaseInfo = 238 '基本信息调整
...
Public Const conMenu_Manage_LookRelatetion = 8299          '查看关联检查
Public Const conMenu_Manage_QueryCFG = 8298          '自定义查询配置
Public Const conMenu_Manage_QueryCfgUserScheme = 8297   '自定义查询配置用户常用方案
Public Const conMenu_Manage_QueryTabDisplayScheme = 8296   '左侧tab显示方案
Public Const conMenu_Manage_QueryValidTime = 8295   '切换科室保持时间范围
...
Public Const conMenu_Manage_ReLoadPDF = 8268                 '重新上传PDF
...
Public Const conMenu_Manage_ExecOnePart = 8241          '分部位执行和取消
Public Const conMenu_Manage_LookMecRecord = 8243         '病案查阅
Public Const conMenu_Manage_SendAudit = 8244         '发送审核
Public Const conMenu_Tool_Valid = 8245
Public Const conMenu_Manage_More = 8246                 '更多
Public Const conMenu_Manage_State = 8247                '状态处理
Public Const conMenu_Manage_Schedule = 8248             '检查预约
Public Const conMenu_Manage_ScheduleManage = 8249             '检查预约
...
Public Const conMenu_Process_AddMark  As Long = 8342
Public Const conMenu_PacsReport_Specialty = 8351            '专科报告
...
Public Const conMenu_PacsReport_Preview = 8368          'Pacs报告预览
Public Const conMenu_PacsReport_Print = 8369            'Pacs报告打印
Public Const conMenu_PacsReport_Write = 8370            'Pacs报告书写

'PACS检查预约
Public Const conMenu_PacsSchdule_New = 8380             '新建预约
Public Const conMenu_PacsSchdule_Modify = 8381          '修改预约
Public Const conMenu_PacsSchdule_Delete = 8382          '删除预约
Public Const conMenu_PacsSchdule_ModifyInfo = 8383      '修改患者信息
Public Const conMenu_PacsSchdule_Refresh = 8384         '刷新
Public Const conMenu_PacsSchdule_Print = 8385           '打印预约单
Public Const conMenu_PacsSchdule_Quit = 8386            '退出
Public Const conMenu_PacsSchdule_Query = 8387           '预约查询
Public Const conMenu_PacsSchdule_Save = 8388            '保存预约
Public Const conMenu_PacsSchdule_SaveAndQuit = 8389     '保存且退出
Public Const conMenu_PacsSchdule_SaveAndCheckin = 8390  '保存且报到退出
...
Public Const conMenu_PatholSpecimen_Cancel = 3952           '回退标本
...
Public Const conMenu_PatholSlices_Cancel = 3953           '制片回退
...
Public Const conMenu_PatholMaterial_Cancel = 3985          '取材回退
...
Public Const conMenu_PatholSpeExam_Cancel = 3986            '特检回退
...
'Pacs占用部分
Public Const conMenu_Check_ViewLink = 4120   '查看关联信息
...
Public Const conMenu_Img_OpenView = 8130        '打开dicom图像
Public Const conMenu_img_ContrastView = 8131    '对比观片
