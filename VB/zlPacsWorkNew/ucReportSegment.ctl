...
'    lngCurOutline = otDesc
    ...
    Call WordInsert(str所见, str诊断, str建议)
Exit Sub
errhandle:
    MsgboxH GetRootHwnd, err.Description, vbOKOnly, "提示"
End Sub
...
Public Sub WordInsert(ByVal str所见 As String, ByVal str诊断 As String, ByVal str建议 As String)
'插入词句
...
On Error GoTo errH
    ...
    If Left(objWordNode.Key, 1) <> LVW_KEY_WORD Then Exit Sub
    
    If MsgboxH(GetRootHwnd, "确定要删除当前选择的词句吗？", vbYesNo + vbDefaultButton2, "提示") = vbNo Then Exit Sub
