...
Private mstrWordName As String  '词句名称
Private mlngDeptID As Long      '科室ID
Private mstr编号 As String


Public Sub zlShowMe(frmParent As Object, ByVal txtWordString As String, ByVal intWordPower As Integer, _
        ByVal lngClassID As Long, ByVal strClassName As String, _
        ByVal lngDeptId As Long, _
        Optional ByRef lngWordID As Long, _
        Optional ByRef strWordName As String)
...
On Error GoTo errH
    ...
    lngWordID = mlngWordID
    strWordName = mstrWordName
...
Private Sub cmdOk_Click()
    ...
    mstrWordName = Trim(Me.txt名称.Text)
