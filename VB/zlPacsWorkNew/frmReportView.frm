...
'Public mblchanged As Boolean     '字号是否改变，设置了报告字体 或者 加载的报告字号与单据字号不同为true 其他情况false
...
Public Sub zlRefresh(ReportID As Long, blnSingleWindow As Boolean, FileID As Long, _
    ...
    strInfo As String, blnShowWord As Boolean, strFormatInfo As String, ByVal blnMoved As Boolean, Optional ByVal lngFormatId As Long)
'参数说明：
...
On Error GoTo errH
    ...
    If mReportID = 0 Then       '报告为空，需要创建报告，从报告模板中提取信息
        ...
        Else
            strSQL = "Select a.内容文本 As 标题, b.对象属性, b.内容文本 As 正文" & vbNewLine & _
