...
Private Sub Form_Activate()
    ...
    Set mrsTemp = zlDatabase.OpenSQLRecord(gstrSQL, "查询诊疗项目", CLng(Me.lblBaseInfo.tag))
    
    With mrsTemp
        If .RecordCount = 0 Then MsgBoxD Me, "在你修改的同时，该项目已经被删除！", vbInformation, gstrSysName: Unload Me: Exit Sub
