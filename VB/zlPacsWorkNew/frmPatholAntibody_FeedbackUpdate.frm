...
On Error GoTo errHandle
    ...
    With mufgFeedback
        ...
        .Text(lngNewRecordIndex, gstrAntibodyFeedback_实验类型) = Trim(zlStr.SubB(cbxExperimentType.Text, InStr(1, cbxExperimentType.Text, "-") + 1, 20))
...
On Error GoTo errHandle
    ...
    With mufgFeedback
        ...
        .Text(.SelectionRow, gstrAntibodyFeedback_实验类型) = Trim(zlStr.SubB(cbxExperimentType.Text, InStr(1, cbxExperimentType.Text, "-") + 1, 20))
...
On Error GoTo errHandle
    ...
    strSQL = "zl_病理抗体反馈_更新(" & lngCurFeedbackId & ",'" & _
                                ...
                                zlStr.To_Date(dtpFeedbackTime.value) & ",'" & _
