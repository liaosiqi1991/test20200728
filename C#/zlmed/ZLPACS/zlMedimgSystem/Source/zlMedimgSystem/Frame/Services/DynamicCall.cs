...
namespace zlMedimgSystem.Services
{
    public class DynamicCall : DisposeImp
    {
        ...
        public object Call(string methodName, params object[] pars)
        {
            ...
            {
                throw new UserException("动态调用方法[" + methodName + "]产生异常。" , ex);
            }
        }
        ...
        public object Get(string propertyName)
        {
            ...
            {
                throw new UserException("动态获取属性[" + propertyName + "]产生异常。", ex);
            }
        }
        ...
        public void Set(string propertyName, object value)
        {
            ...
            {
                throw new UserException("动态设置属性[" + propertyName + "]产生异常。", ex);
            }            
        }
